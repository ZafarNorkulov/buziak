    ...
    return (
        <div className='w-full h-full flex flex-col gap-2 '>
            <div className='w-full flex flex-col justify-center items-center'>
                ...
                <span className='text-white/70 font-jakarta'>Последний твит</span>
            </div>
            ...
            {/* <div className='h-[100px] w-full flex justify-center'>
                ...
                <p className='text-sm leading-[120%] font-jakarta text-white/70'>Пользователь еще не оставил постов...</p>
            </div> */}
