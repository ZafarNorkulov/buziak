...
const GradientButton = ({ children, icon, shadow, className = "", onClick }: { children: React.ReactNode, icon?: StaticImageData, shadow?: boolean, className?: string, onClick?: () => void }) => {
    return (
