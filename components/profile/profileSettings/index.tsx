...
const ProfileSettings = () => {
    return (
        <section >
            <div className='max-container !px-[11px]'>
                <div className='flex items-start justify-between'>
                    <BackButton />
                    <div className='flex flex-col items-center gap-2'>
                        <Image src={noImage} width={90} height={90} className='border-[3px] border-white rounded-full' alt='noImage ' />
                        <div className='px-3.5 py-1.5 bg-[#675B78] rounded-2xl'>
                            <label htmlFor='file' className='text-sm tracking-[1px] leading-none'>Change Profile Picture
